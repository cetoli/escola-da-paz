  ...
  def signup
    if request.post?
      ...
      if @user.save
        ...
        Notifications.deliver_userApproval('adm.escola.paz@gmail.com', @user.nome, @user.email)
        redirect_to :action => "about"
      else
        @escolaridades = Escolaridade.find(:all).collect{ |t| [t.nome, t.id] }
        @cursos = Curso.find(:all).collect{ |t| [t.nome, t.id] }
