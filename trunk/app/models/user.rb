...
class User < ActiveRecord::Base
  ...
  validates_presence_of :nome, :login, :senha, :senha_confirmation, :salt, :email, :bairro, :cep, :telefone, :celular, :endereco, :formacao, :interesse, :periodo, :turno, :cr, :dre, :instituicao
